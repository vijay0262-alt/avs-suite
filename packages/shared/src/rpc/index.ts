...
export const RPC_METHODS = {
  ...
  DASHBOARD_SECURITY_SCORE: 'dashboard.securityScore',
  UPDATER_AVAILABLE: 'updater.available',
  UPDATER_LIST: 'updater.list',
  UPDATER_UPGRADE: 'updater.upgrade',
  ...
  BROWSER_EXT_SCAN_THREATS: 'browser_ext.scanThreats',
  ...
  THREAT_BEHAVIORAL_SCAN: 'threat.behavioralScan',
  THREAT_SCAN_STATUS: 'threat.scanStatus',
  DOWNLOAD_SCANNER_STATUS: 'download_scanner.status',
  DOWNLOAD_SCANNER_START: 'download_scanner.start',
  DOWNLOAD_SCANNER_STOP: 'download_scanner.stop',
  DOWNLOAD_SCANNER_EVENTS: 'download_scanner.events',
  DOWNLOAD_SCANNER_SCAN_FILE: 'download_scanner.scanFile',
  MEMORY_SCANNER_STATUS: 'memory_scanner.status',
  MEMORY_SCANNER_SCAN: 'memory_scanner.scan',
  MEMORY_SCANNER_SCAN_PROCESS: 'memory_scanner.scanProcess',
  MEMORY_SCANNER_EVENTS: 'memory_scanner.events',
  EMAIL_SCANNER_STATUS: 'email_scanner.status',
  EMAIL_SCANNER_SCAN_MAILBOX: 'email_scanner.scanMailbox',
  EMAIL_SCANNER_SCAN_FILE: 'email_scanner.scanFile',
  EMAIL_SCANNER_EVENTS: 'email_scanner.events',
  CLOUD_REPUTATION_LOOKUP: 'cloud_reputation.lookup',
  CLOUD_REPUTATION_LOOKUP_FILE: 'cloud_reputation.lookupFile',
  CLOUD_REPUTATION_REPORT: 'cloud_reputation.report',
  CLOUD_REPUTATION_WHITELIST: 'cloud_reputation.whitelist',
  CLOUD_REPUTATION_STATUS: 'cloud_reputation.status',
  CLOUD_REPUTATION_CACHE: 'cloud_reputation.cache',
  NETWORK_MONITOR_STATUS: 'network_monitor.status',
  NETWORK_MONITOR_SCAN: 'network_monitor.scan',
  NETWORK_MONITOR_EVENTS: 'network_monitor.events',
  NETWORK_MONITOR_BLOCKLIST: 'network_monitor.blocklist',
  EMAIL_NOTIFY_STATUS: 'email_notify.status',
  EMAIL_NOTIFY_CONFIGURE: 'email_notify.configure',
  EMAIL_NOTIFY_TEST: 'email_notify.test',
  EMAIL_NOTIFY_SEND: 'email_notify.send',
  EMAIL_NOTIFY_HISTORY: 'email_notify.history',
  SECURITY_STATUS: 'security.status',
  SECURITY_REALTIME_STATUS: 'security.realTimeStatus',
  SECURITY_CONSOLIDATED_SCORE: 'security.consolidatedScore',
  ...
  THREAT_QUARANTINE_LIST: 'threat.quarantineList',
  THREAT_QUARANTINE_RESTORE_ALL: 'threat.quarantineRestoreAll',
  THREAT_QUARANTINE_DELETE_ALL: 'threat.quarantineDeleteAll',
  THREAT_QUARANTINE_DELETE_SELECTED: 'threat.quarantineDeleteSelected',
  THREAT_QUARANTINE_STATS: 'threat.quarantineStats',
  THREAT_QUARANTINE_SEARCH: 'threat.quarantineSearch',
  THREAT_QUARANTINE_CLEANUP: 'threat.quarantineCleanup',
  THREAT_QUARANTINE_EXPORT: 'threat.quarantineExport',
  THREAT_QUARANTINE_POLICIES: 'threat.quarantinePolicies',
  THREAT_QUARANTINE_POLICY_SET: 'threat.quarantinePolicySet',
  THREAT_QUARANTINE_POLICY_RESET: 'threat.quarantinePolicyReset',
  THREAT_HISTORY: 'threat.history',
  THREAT_REPORT_FALSE_POSITIVE: 'threat.reportFalsePositive',
  ...
  REALTIME_THREAT_USB_AUTO_SCAN_START: 'realtime_threat.usbAutoScanStart',
  REALTIME_THREAT_USB_AUTO_SCAN_STOP: 'realtime_threat.usbAutoScanStop',
  REALTIME_THREAT_USB_AUTO_SCAN_STATUS: 'realtime_threat.usbAutoScanStatus',
  ...
  ADV_SECURITY_EMAIL_SCAN_OUTLOOK: 'advanced_security.email.scanOutlook',
