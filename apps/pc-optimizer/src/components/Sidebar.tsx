...
const NAV_SECTIONS: readonly NavSection[] = [
  ...
  // ── SECURITY ──────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      { id: 'persistence-detection', to: '/persistence-detection', labelKey: 'nav.persistenceDetection', Icon: CommandLineIcon },
      { id: 'network-behavior-analysis', to: '/network-behavior-analysis', labelKey: 'nav.networkBehaviorAnalysis', Icon: WifiIcon },
      { id: 'file-reputation-analysis', to: '/file-reputation-analysis', labelKey: 'nav.fileReputationAnalysis', Icon: ShieldCheckIcon },
      { id: 'publisher-trust-analysis', to: '/publisher-trust-analysis', labelKey: 'nav.publisherTrustAnalysis', Icon: ShieldExclamationIcon },
