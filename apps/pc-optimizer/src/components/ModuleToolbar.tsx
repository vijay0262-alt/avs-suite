    ...
    >
      ...
      {selects?.map((sel) => (
        <select
          ...
          className="rounded-md border border-border bg-bg-secondary px-3 py-1.5 text-sm text-text-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary"
        >
          {sel.options.map((opt) => (
