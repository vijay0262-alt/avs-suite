...
<head>
  ...
  <title>AVS Shield Report — ${report.moduleName} — ${formatTimestamp(report.timestamp)}</title>
  <style>${styles}</style>
</head>
<body>
  <h1>AVS Shield — ${report.moduleName}</h1>
  <div class="meta">
  ...
  <div class="footer">
    Generated by AVS Shield — Advanced Vision Software LLC<br />
