...
export const dashboardService: DashboardService = {
  getMetrics: () => rpcCache.get('dashboard.metrics', () => client().call<DashboardMetrics>(RPC_METHODS.DASHBOARD_METRICS), 60_000),
  getLiveMetrics: () => client().call(RPC_METHODS.DASHBOARD_LIVE),
  getHealthScore: () => rpcCache.get('dashboard.health', () => client().call<HealthScore>(RPC_METHODS.DASHBOARD_HEALTH), 60_000),
