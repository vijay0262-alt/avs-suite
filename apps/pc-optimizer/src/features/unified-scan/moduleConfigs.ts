  ...
  phases: [
    {
      ...
      description: 'Initializing optimization engine',
      startPercent: 0,
      endPercent: 5,
      activities: [
    ...
    },
    {
      id: 'junk',
      label: 'Junk Analysis',
      description: 'Scanning temporary files, cache, logs',
      startPercent: 5,
      endPercent: 20,
      activities: [
    ...
    },
    {
      ...
      description: 'Scanning cookies, history, tracking data',
      startPercent: 20,
      endPercent: 35,
      activities: [
        'Scanning cookies...',
    ...
    },
    {
      ...
      description: 'Scanning registry keys and broken entries',
      startPercent: 35,
      endPercent: 50,
      activities: [
    ...
    },
    {
      ...
      description: 'Scanning startup apps, services, scheduled tasks',
      startPercent: 50,
      endPercent: 65,
      activities: [
    ...
    },
    {
      ...
      description: 'Scanning processes, memory, storage, drivers',
      startPercent: 65,
      endPercent: 80,
      activities: [
    ...
    },
    {
      ...
      description: 'Calculating impact, risk, and optimization plan',
      startPercent: 80,
      endPercent: 95,
      activities: [
    ...
    },
    {
      id: 'finalizing',
      label: 'Finalizing',
      description: 'Preparing recommendations and verification',
      startPercent: 95,
      endPercent: 100,
      activities: [
