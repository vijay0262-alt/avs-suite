            ...
            <div className="border-t border-[var(--avs-border)] pt-3">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-caption text-left">
                  ...
                  <tbody>
                    {[
                      { label: 'Junk Cleaner', free: true, pro: true },
                      { label: 'Registry Cleaner (scan + fix)', free: true, pro: true },
                      { label: 'Startup Manager (full control)', free: true, pro: true },
                      { label: 'Browser & Privacy Cleaner', free: true, pro: true },
                      { label: 'Duplicate Finder', free: true, pro: true },
                      { label: 'File Shredder', free: true, pro: true },
                      { label: 'Security Scan', free: true, pro: true },
                      { label: 'Disk Analyzer', free: 'Analyze only', pro: 'Analyze + delete' },
                      { label: 'Large Files Finder', free: true, pro: true },
                      { label: 'AI Smart Optimization', free: '—', pro: true },
                      { label: 'AI Predictive Health', free: '—', pro: true },
                      { label: 'AI Process Intelligence', free: 'Limited', pro: true },
                      { label: 'AI Hardware Intelligence', free: 'Limited', pro: true },
                      { label: 'Real-Time Threat Protection', free: '—', pro: true },
                      { label: 'Software Uninstaller', free: '—', pro: 'Batch + cleanup' },
                      { label: 'Software Updater', free: '—', pro: true },
                      { label: 'Driver Updater', free: '—', pro: true },
