...
from .enums import SafetyBlocker, SafetyLevel
...
class SafetyAssessment:
    ...
    @classmethod
    def create_low_risk(cls, reason: str) -> SafetyAssessment:
        """Create a LOW_RISK assessment."""
        return cls(level=SafetyLevel.LOW_RISK, reason=reason, blockers=tuple())
    ...
    @classmethod
    def create_high_risk(cls, reason: str) -> SafetyAssessment:
        """Create a HIGH_RISK assessment."""
        return cls(level=SafetyLevel.HIGH_RISK, reason=reason, blockers=tuple())
