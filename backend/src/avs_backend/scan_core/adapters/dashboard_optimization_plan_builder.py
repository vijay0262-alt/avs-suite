"""
SC-8C13 Phase 2 — Dashboard Optimization Plan Builder

Builds a canonical scan_core ActionPlan from Dashboard Optimize preview output.
...
- ONLY constructs the action plan
"""
...
from .dashboard_optimization_adapter import DashboardOptimizationAdapter
...
class DashboardOptimizationPlanBuilder:
    """
    Builds canonical ActionPlan objects from Dashboard Optimize preview output.
    ...
    def __init__(
        self,
        adapter: Optional[DashboardOptimizationAdapter] = None,
        ...
        Args:
            adapter: Optional DashboardOptimizationAdapter instance
            capability_contract: Optional CapabilityContract for adapter
        """
        self.adapter = adapter or DashboardOptimizationAdapter(
    ...
    def build_plan(
        ...
        """
        Build a canonical ActionPlan from Dashboard Optimize actions.
        ...
        """
        # Convert Dashboard Optimize actions to RemediationActions
