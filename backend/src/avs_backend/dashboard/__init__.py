...
# SC-8C13 Phase 5: dashboard.optimize.execute RPC removed.
# Dashboard optimization now uses scan_core.dashboard_optimization.plan →
# scan_core.remediation.prepare → validate → approve → execute.
# The legacy direct-execution function has been deleted.
