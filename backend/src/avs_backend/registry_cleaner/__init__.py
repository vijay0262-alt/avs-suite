...
@register("registry.scan.progress")
def registry_scan_progress(_params: dict[str, Any] | None) -> dict[str, Any]:
    """Return live scan progress (current registry path) for UI polling."""
